...
public class Main extends NativeActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    //System.err.println("pmx : debug : Main::onCreate : 015");
...
/*
        ...
        Log.v("pmx::Main::onCreate","http intent : "+
              action+" : "+intent.getDataString()+" : "+intent.getType());
        DownloadManager.Request r = new DownloadManager.Request(uri);
        r.setDestinationInExternalPublicDir("/sdcard/Android/data/fr.in2p3.lal.pmx","DOCUMENT");
...
*/
  ...
  private void load_resources() {
    ...
    // app_dir is : /data/data/fr.in2p3.lal.pmx/files
  ...
  private void uri_to_file(Uri a_uri,String a_file) {
    try {
      ...
      Log.e("pmx::uri_to_file "," exception: " + e.getMessage());
    }
  }
